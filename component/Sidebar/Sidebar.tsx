  ...
  },
  {
    ...
    items: [
      ...
      { label: "Departments", href: "/deperatments", icon: icons.departments },
      {
        ...
        href: "/diagnosticcenters/add",
        icon: icons.diagnosticCenters,
      },
    ],
  },
  {
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div style={styles.mobileTopbar} className="lg:hidden">
        <button
      ...
      <aside
        ...
        className={`fixed lg:sticky top-0 left-0 z-[1000] w-[210px] min-w-[210px] h-screen transition-transform duration-300 ease-in-out lg:translate-x-0 ${
