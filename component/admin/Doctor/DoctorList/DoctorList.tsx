...
//               } else {
//                 setPage(1); // this DOES change page -> triggers useDoctorList's effect
//               }
//             }}
//           />
//         </Modal>
...
const DoctorList = () => {
  ...
  // Independent, non-paginated fetch used ONLY for the stat cards below,
  // so Fees / Avg slot duration reflect every doctor, not just this page.
