...
//       <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-xl space-y-5 rounded-xl border border-white/10 bg-[#141417] p-6">
...
//             <input {...register("departmentId")} className={inputClass} />
//           </div>
//         </div>
...
//             <input {...register("schedule.startTime")} placeholder="09:00" className={inputClass} />
//           </div>
//           <div>
//             <label className={labelClass}>End time</label>
//             <input {...register("schedule.endTime")} placeholder="17:00" className={inputClass} />
//           </div>
//           <div>
...
//         <button type="submit" className="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium hover:bg-blue-500">
//           Update doctor
//         </button>
//       </form>
//     </div>
